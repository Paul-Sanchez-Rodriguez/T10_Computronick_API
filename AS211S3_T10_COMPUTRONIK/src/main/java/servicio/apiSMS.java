...
public class apiSMS {
    ...
    public static JSONObject consumiendoAPI2(String nro) throws UnirestException {
        ...
        HttpResponse<String> response = Unirest.post("https://clicksend.p.rapidapi.com/sms/send")
                ...
                .body("{\n  \"messages\": [\n    {\n    "
                        + "  \"source\": \"mashape\",\n    "
                        + "  \"from\": \"Test\",\n    "
                        + "  \"body\": \"Has sido registrado con exito, disfrute de nuestra tienda, que tenga buen dia\",\n  "
                        + "    \"to\": \"+51" + nro + "\",\n     "
                        + " \"schedule\": \"1452244637\",\n    "
    ...
    public static void main(String[] args) throws Exception {
        ...
        JSONObject json = apiSMS.consumiendoAPI2("912602977");
        System.out.println("mensaje que se envio es " + json.getString("body"));
        System.out.println("mensaje que se envio es " + json.getString("carrier"));
